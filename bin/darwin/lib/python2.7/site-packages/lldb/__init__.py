...
swig_version = (_to_int(0x030004 // 0x10000), _to_int(0x030004 // 0x100), _to_int(0x030004))
del _to_int
...
class SBDebugger(_object):
    ...
    def EnableForwardEvents(self, listener):
        """EnableForwardEvents(SBDebugger self, SBListener listener)"""
        return _lldb.SBDebugger_EnableForwardEvents(self, listener)


    def CancelForwardEvents(self):
        """CancelForwardEvents(SBDebugger self)"""
        return _lldb.SBDebugger_CancelForwardEvents(self)
